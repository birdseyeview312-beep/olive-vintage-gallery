...
function card(p,index){
  ...
  const action=isSold?`<span class="collection-status sold">Sold</span>`:canBuy?`<button class="product-buy-now" type="button" data-buy-product="${esc(p.id)}">Buy Now <span>↗</span></button>`:`<a class="product-inquire" href="mailto:Olivejewelvintage@gmail.com?subject=${inquirySubject}" data-inquiry-type="buyer">Inquire <span>↗</span></a>`;
